...
def sudoku_constraints(T1,v1,T2,v2,csg=csgraph):
    # tasks = csg["vertex"]
...
taskscsp = tasksCSP(csgraph["vertex"], csgraph["domains"], csgraph["neighbors"], csgraph["pandcs"], sudoku_constraints)
